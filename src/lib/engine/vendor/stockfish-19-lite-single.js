		...
		function e(e) {
				...
				L =
					(W
						? ((p = l ? require('path').dirname(p) + '/' : __dirname + '/'),
						  ...
						  (n = function (e, n) {
								return (
									k(), (e = r.normalize(e)), H.readFileSync(e, n ? void 0 : 'utf8')
								);
						  }),
					...
					l = {
							...
							return i(t, (e = new Date(e.J + 1900, e.K, e.L))) < 0
								? a(
										Math.ceil(
											(31 -
												t.getDate() +
												(ye(A(e.getFullYear()) ? x : R, e.getMonth() - 1) - 31) +
												e.getDate()) /
												7
										),
										2
						...
						'%W': function (e) {
							var n = new Date(e.J, 0, 1),
								t =
									1 === n.getDay() ? n : C(n, 0 === n.getDay() ? 1 : 7 - n.getDay() + 1);
							return i(t, (e = new Date(e.J + 1900, e.K, e.L))) < 0
								? a(
										Math.ceil(
											(31 -
						...
						? ((a = o = !1),
						  e(() => {
								if (!v && ((o = !0), a)) {
									...
									if (
										(O ||
											((e = be) && ((be = null), (n ? e.reject : e.resolve)(t), (r = !0))),
										n && !r)
									)
										throw t;
								}
			...
			var I,
				Ae = {
					...
					h: function (e, n) {
						...
						return (
							(g[n >> 2] = (e / 1e3) | 0), (g[(n + 4) >> 2] = ((e % 1e3) * 1e6) | 0), 0
						);
					},
					j: function (e, n, t) {
						var r;
						for (fe.length = 0, t >>= 2; (r = y[n++]); )
							(r = r < 105) && 1 & t && t++, fe.push(r ? J[t++ >> 1] : g[t]), ++t;
			...
			if (
				...
				(f.ccall = function (e, n, t, r, o) {
					function a(e) {
						return (
							--_, 0 !== s && Ee(s), 'string' === n ? X(e) : 'boolean' === n ? !!e : e
						);
					}
					var i = {
							string: function (e) {
						  ...
						  require('readline')
								.createInterface({
									...
									completer: function (n) {
										...
										return [
											(r = r.length ? r : (n = n.replace(/^.*\s/, '')) ? e.filter(t) : e),
											n,
										];
									},
									historySize: 100,
								...
								.on('line', function (e) {
									e &&
										(c.processCommand ? c.processCommand(e) : r.push(e), 'quit' === e) &&
										process.exit();
								})
								.on('close', function () {
									process.exit();
